...
const ElmaramLogo = "" + new URL("maram-oSU1jdvH.jpg", import.meta.url).href;
function App() {
  ...
  const [dataFetching, setDataFetching] = reactExports.useState([]);
  ...
  reactExports.useEffect(() => {
    fetch(`https://pharmacy-api-5i0h.onrender.com/api/v1/users?fields=-_id,-password`).then((res) => res.json()).then((json) => {
      console.log(json);
  ...
  let handleDelete = async () => {
    try {
      const response = await fetch(`https://pharmacy-api-5i0h.onrender.com/api/v1/users?page=2&limit=5&sort=name&keyword=${inputName}`, {
        method: "DELETE"
      });
      if (response.ok) {
  ...
  let handleSearchBar = async (value) => {
    try {
      const response = await fetch(`https://pharmacy-api-5i0h.onrender.com/api/v1/users?page=2&limit=5&sort=name&keyword=${value}`);
      if (response.ok) {
        const json = await response.json();
        setDataFetching(Array.isArray(json) ? json : []);
      } else {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "parent", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leftParent", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("input", { onChange: (e) => handleSearchBar(e.target.value), className: "searchBar", placeholder: "بحث", type: "text" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "logo", src: ElmaramLogo, alt: "logo" }),
      dataFetching.map((info, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rightParent", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "btnBar", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn", onClick: handleAdd, children: "اضافه" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleDelete, className: "btn", children: "حذف" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "btn", children: "تعديل" })
      ] })
    ] })
  ] }) });
}
